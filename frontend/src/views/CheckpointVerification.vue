<template>
  <div class="checkpoint-verification">
    ...
    <!--
      自動驗證的運作狀態（audit-chain-scheduled-verification D8）。
...
// 繞行一輪的預估：**照實顯示，不隱藏**（design D2.3）。逐筆重驗是十億列級的
...
// ---------------------------------------------------------------------------
// 調查頁帶入的範圍（?seq_from=&seq_to=，workbench-exits-and-export 出口 B）
//
// **只預填，絕不自動觸發驗證。** 三個可指認的理由（design D4）：
