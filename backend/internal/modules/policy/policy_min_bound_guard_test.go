...
var keysNotRequiringMin = map[string]string{
	PolicyAgentSelfCreateMaxPerOwner: "調小是更嚴格配額而非機制失效；ZeroDisables=false 拒 0，Max=100 限制放寬。",
	PolicyAgentProbeTripCount:        "調小更嚴格；1 次為可運作門檻，不允許零次。",
	PolicyAgentProbeWindowSeconds:    "調小會縮短計數窗，是可見政策選擇；1 秒仍可計數且禁止零窗。",
	PolicyAgentRequestRatePerHour:    "調小會更嚴格限制開單，不會靜默關閉保護；ZeroDisables=false 已拒 0。",
	PolicyAgentRequestPendingMax:     "調小會更嚴格限制待審單，不會靜默關閉保護；ZeroDisables=false 已拒 0。",
