...
> （`20260816_schema_baseline`）為起點，其後以**增量 migration** 演進（本版的六條見下 §2.5）；
...
本版的資料庫有 schema baseline（`20260816_schema_baseline`）與其後的六條增量
...
`20260903_rotation_evidence_report`）。
