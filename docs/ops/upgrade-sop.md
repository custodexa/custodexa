...
本版的資料庫有**四條** migration：schema baseline（`20260816_schema_baseline`）
與其後的三條增量（`20260824_audit_export_jobs`、`20260825_evidence_offsite`、
`20260826_source_ip_forensics`）。**四條都不提供把資料退回升級前狀態的手段。**
